...
'@
[System.IO.File]::WriteAllText('src/components/AccessorySettlementPage.tsx', , [System.Text.Encoding]::UTF8)
...
'@
[System.IO.File]::AppendAllText('src/components/AccessorySettlementPage.tsx', , [System.Text.Encoding]::UTF8)
