        ...
        <div style={{ animation: 'fadeIn 0.5s ease-out' }}>
          ...
          {activeCategory === 'detailing' ? (
            ...
            <div className="glass-panel" style={{ padding: '25px', borderRadius: '20px', border: '1px solid #e2e8f0', gridColumn: 'span 2' }}>
              ...
              <div style={{ marginTop: '25px', padding: '15px 20px', background: '#f5f3ff', borderRadius: '15px', border: '1px solid #ddd6fe', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
                  <div style={{ background: '#7c3aed', color: '#fff', padding: '6px', borderRadius: '10px' }}>
                    <ShieldCheck size={20} />
                  </div>
                  <div>
                    <div style={{ fontWeight: 'bold', color: '#5b21b6', fontSize: '0.95rem' }}>全車改色加購 - 引擎蓋+前葉子板犀牛皮</div>
                    <div style={{ fontSize: '0.75rem', color: '#7c3aed' }}>品牌: Pixel8bit (針對易跳石區域加強保護)</div>
                  </div>
                </div>
                <div style={{ fontSize: '1.4rem', fontWeight: '900', color: '#5b21b6' }}>
                  <span style={{ fontSize: '0.9rem', marginRight: '3px' }}>+ $</span>18,000
                </div>
              </div>
          ...
          <div style={{ marginTop: '30px', display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '25px' }}>
             ...
             <div className="glass-panel" style={{ padding: '25px', borderRadius: '20px', border: '1px solid #e2e8f0', gridColumn: 'span 2' }}>
                <h4 style={{ marginBottom: '15px', color: '#1e293b', fontWeight: '800', display: 'flex', alignItems: 'center', gap: '8px' }}>
                  <MonitorPlay size={20} /> 安全升級首選 - 行車記錄器 ＆ 電子後視鏡
                </h4>
